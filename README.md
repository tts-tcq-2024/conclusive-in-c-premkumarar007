...
I had planned to reduce the cyclomatic complexities of typescript components of my angular project and implement unit test with the help of karma and jasmine in it and also I will refactor my code for bigger and complex functions wit the knowledge I had got through this program.
